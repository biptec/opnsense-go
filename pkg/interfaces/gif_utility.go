...
// GifUtilityGetIfOptions executes the GetIfOptions RPC call of the GifUtility controller
func (c *Controller) GifUtilityGetIfOptions(ctx context.Context) (*map[string]interface{}, error) {
