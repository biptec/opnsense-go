...
Ordinary unit and compile checks run without a firewall:

```sh
make check
```

Live integration tests require an OPNsense instance. Set the following environment variables before running `make testacc`:
